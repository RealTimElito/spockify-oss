...
Coding loop for CLI (and eventually IDE/lab) lives in `packages/spockify-harness`. Entry: `runHarness` / `spockify agent --mode plan|build`. See [`docs/HARNESS.md`](HARNESS.md) and [`docs/CODING_MODELS.md`](CODING_MODELS.md).
