        ...
        try:
            ...
            if file_path.is_file():
                ...
                if attachment:
                    ...
                    # Inline for media so <video>/<img> can play/show in chat.
                    # attachment disposition makes many browsers download instead
                    # of rendering (broken generated-video playback).
                    if (
                        ct == 'application/pdf'
