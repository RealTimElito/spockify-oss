...
export const THINKING_MODE_META: readonly ThinkingModeMeta[] = [
	...
	},
	{
		id: 'medium',
		label: 'Medium',
		hint: 'Balanced auto route with live-fact search; may SPAWN when subtasks are clear'
	},
	{
		id: 'high',
		label: 'High',
		hint: 'High effort; can SPAWN parallel workers mid-thought when useful'
	},
	{
		id: 'heavy',
		label: 'Heavy',
...
/** Default Spark heavy ensemble (English). CJK/Arabic/Hangul overlay via planHeavyEnsemble. */
