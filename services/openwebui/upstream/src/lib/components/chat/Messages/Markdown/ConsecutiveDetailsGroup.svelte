...
<div {id} class="w-full">
	...
	<button
		class="w-fit text-left text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition cursor-pointer text-xs"
	...
	>
		<div class="flex items-center gap-1.5">
			...
			<!-- Summary text -->
			<div class="flex-1 line-clamp-1 italic opacity-90">
