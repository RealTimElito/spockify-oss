	...
	<div class="flex flex-col flex-1 gap-1.5">
		...
		<div class="flex items-center gap-2">
			...
			<div class="flex flex-col min-w-0 flex-1">
				...
				{#if item?.model?.info?.meta?.description || item?.model?.meta?.description}
					{@const cardDesc = (
					...
					{#if cardDesc}
						<div
							class="text-[11px] font-normal text-gray-500 dark:text-gray-400 line-clamp-2 leading-snug mt-0.5"
						>
							{cardDesc}
						</div>
					{/if}
