<script lang="ts">
	...
	export let spockifyImageAspect: 'square' | 'wide' | 'tall' = 'square';
	export let onSpockifyImageAspectChange: (aspect: 'square' | 'wide' | 'tall') => void = () => {};
	export let spockifyImageStyle: '' | 'photo' | 'illustration' = '';
	export let onSpockifyImageStyleChange: (style: '' | 'photo' | 'illustration') => void = () => {};
	export let spockifyVideoDuration: 'short' | 'default' | 'long' = 'default';
	export let onSpockifyVideoDurationChange: (
		...
		<div class="w-full flex flex-col justify-center items-center">
			...
			<div class="text-base font-normal @md:max-w-3xl w-full py-3 {atSelectedModel ? 'mt-2' : ''}">
				<MessageInput
					...
					{onSpockifyParallelAgentsChange}
					bind:spockifyPrivacyMode
					{onSpockifyPrivacyModeChange}
					bind:spockifyImageAspect
					{onSpockifyImageAspectChange}
					bind:spockifyImageStyle
					{onSpockifyImageStyleChange}
					bind:spockifyVideoDuration
					{onSpockifyVideoDurationChange}
