...
>
	...
	<div class=" space-y-3 overflow-y-scroll max-h-[28rem] md:max-h-full">
		<div>
			...
			<div class=" my-2 text-sm font-medium">Canvas</div>
			...
			<div>
				...
				<div class=" text-[11px] text-gray-500 dark:text-gray-400 px-0.5 pb-1">
					Default for Integrations → Canvas. When on (or Canvas toggle is on), long docs/code open
