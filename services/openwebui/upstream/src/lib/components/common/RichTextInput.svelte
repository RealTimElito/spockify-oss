<script lang="ts">
	...
	export const setText = (text: string) => {
		...
		// Do not autofocus here — callers focus when appropriate.
		// Autofocus opened the mobile keyboard after every Call STT submit
		// (Chat submitHandler → setText('') while Call overlay is open).
	};
