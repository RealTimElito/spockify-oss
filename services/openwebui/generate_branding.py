...
Used at image build time. Prefer tracked ``branding/`` (or ``--prebuilt`` /
homelab sync from ``k8s/openwebui/assets``). If favicon.png is missing, a
placeholder mark is generated — Dockerfile rejects that for release builds.
"""
