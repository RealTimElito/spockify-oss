...
describe('normalizePathHint', () => {
  it('strips quotes and ./ but keeps absolute paths', () => {
    ...
    assert.equal(
      normalizePathHint('/workspace/safer/scripts/continuous_training.py'),
      '/workspace/safer/scripts/continuous_training.py',
    );
  });
});
...
describe('scorePathMatch', () => {
  ...
  it('scores absolute hints', () => {
    const abs = '/workspace/safer/scripts/continuous_training.py';
