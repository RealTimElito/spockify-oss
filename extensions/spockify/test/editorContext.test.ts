...
describe('selectionChipFromSnapshot', () => {
  it('builds Cursor-style chip label fields', () => {
    const chip = selectionChipFromSnapshot({
      fileName: '/workspace/spockify/docker-compose.yml',
      filePath: '/workspace/spockify/docker-compose.yml',
    ...
    assert.equal(chip.id, '/workspace/spockify/docker-compose.yml:10-20');
  });
