...
Scaffold landed: [docs/BENCH.md](../../../docs/BENCH.md), `spockify bench`, `scripts/run-swebench.sh` (dry-run / smoke / SWE-bench Lite via mini-SWE-agent). Twin or compose LiteLLM only; start with `--slice 0:1`. Do not fold Heavy ensemble into a coding harness; leave Tab/FIM alone.
