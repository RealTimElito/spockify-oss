...
export interface ChatStreamChunk {
  ...
  workerModel?: string;
  /**
   * Mid-thought / Heavy / parallel-agents run snapshot from router SSE
   * (`spockify_agents`). IDE chat should show chips via agentRunCard — do not
   * also call ``spockify_create_agent_run`` for the same turn.
   */
  spockifyAgents?: Record<string, unknown>;
