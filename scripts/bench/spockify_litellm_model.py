...
def _is_retry_storm_fail(exc: BaseException) -> bool:
    """Soft-fail LiteLLM/Ollama 500 storms and read timeouts.

    Uncaught APITimeoutError aborts the instance with no preds.json entry
    (board resume gap). Soft-fail into recovery bash and let empty-stop
    streak eventually hard-finish.
    """
